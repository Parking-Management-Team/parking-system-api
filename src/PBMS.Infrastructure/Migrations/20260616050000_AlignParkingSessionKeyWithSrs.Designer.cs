...
namespace PBMS.Infrastructure.Migrations
{
    ...
    [Migration("20260616050000_AlignParkingSessionKeyWithSrs")]
    partial class AlignParkingSessionKeyWithSrs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PBMS.Domain.Entities.Payment", b =>
                {
                    ...
                    b.ToTable("payment", null, t =>
                        {
                            t.HasCheckConstraint("CK_Payment_Source", "(CASE WHEN session_id IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN booking_id IS NOT NULL THEN 1 ELSE 0 END) + (CASE WHEN monthly_subscription_id IS NOT NULL THEN 1 ELSE 0 END) = 1");
                        });
                });
            ...
            modelBuilder.Entity("PBMS.Domain.Entities.Zone", b =>
                {
                    ...
                    b.Property<string>("ZoneAccessType")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
