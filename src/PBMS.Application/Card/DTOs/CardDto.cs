...
///   - GET /api/cards/{id}
///   - GET /api/cards/by-rfid/{rfidCode}
...
public class CardDto
{
    ...
    /// <summary>
    /// Mã RFID của con chip trên thẻ vật lý.
    /// Null nếu thẻ chưa được gán mã RFID.
    /// </summary>
    public string? RfidCode { get; set; }

    /// <summary>
    /// ID tòa nhà mà thẻ này thuộc về.
    /// Null nếu thẻ chưa được phân công cho tòa nhà nào.
    /// </summary>
