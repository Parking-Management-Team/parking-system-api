...
| 🏗️ [KIẾN TRÚC HỆ THỐNG](architecture/ARCHITECTURE.md) | Phân tích chi tiết Clean Architecture, luồng phụ thuộc (Dependency flow), và trách nhiệm của từng Layer (`API`, `Application`, `Domain`, `Infrastructure`). |
| 🚀 [HƯỚNG DẪN CÀI ĐẶT](development/SETUP_GUIDE.md) | Yêu cầu hệ thống, các bước thiết lập môi trường phát triển local, restore packages, migration database và chạy ứng dụng. |
...
| 💡 [CƠ SỞ TRI THỨC (KB)](development/KNOWLEDGE_BASE.md) | Các tài khoản test, liên kết hữu ích, các tập lệnh thường dùng và cẩm nang lưu ý cho lập trình viên mới. |
...
2. Làm theo từng bước trong [HƯỚNG DẪN CÀI ĐẶT](development/SETUP_GUIDE.md) để thiết lập dự án chạy được trên máy của bạn.
3. Đảm bảo tuân thủ nghiêm ngặt quy trình làm việc được định nghĩa trong [QUY TRÌNH PHÁT TRIỂN](development/DEVELOPMENT_WORKFLOW.md) trước khi tạo bất kỳ Pull Request nào.
