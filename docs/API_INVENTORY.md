...
| `/api/parking-sessions/check-in` | `POST` | Gửi xe thực tế | `ParkingSessionsController` | ✅ Có | Đăng ký xe vào bãi (Check-In) |
...
| `/api/parking-sessions/{id}/checkout/start` | `PATCH` | Gửi xe thực tế | `ParkingSessionsController` | ✅ Có | Bắt đầu quy trình kiểm tra xe ra (Check-Out) |
| `/api/parking-sessions/{id}/complete` | `PATCH` | Gửi xe thực tế | `ParkingSessionsController` | ✅ Có | Hoàn tất phiên gửi xe (Xe rời bãi) |
| `/api/parking-sessions/{id}/checkout/rollback` | `PATCH` | Gửi xe thực tế | `ParkingSessionsController` | ✅ Có | Hủy bỏ quy trình thanh toán/ra bãi |
...
| `/api/vehicle-types` | `GET` | Phương tiện | `VehicleTypeController` | ✅ Có | Lấy danh sách tất cả các loại xe |
| `/api/vehicle-types/{id}` | `GET` | Phương tiện | `VehicleTypeController` | ✅ Có | Xem chi tiết loại xe theo ID |
| `/api/vehicle-types` | `POST` | Phương tiện | `VehicleTypeController` | ✅ Có | Tạo mới loại xe |
| `/api/vehicle-types/{id}` | `PUT` | Phương tiện | `VehicleTypeController` | ✅ Có | Cập nhật loại xe |
